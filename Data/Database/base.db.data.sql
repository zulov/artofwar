...
INSERT INTO `unit_type` (id,name) VALUES (0,'warrior'),
 ...
 (3,'archer'),
 (4,'worker');
INSERT INTO `resource` (id,name,icon,maxCapacity,texture,model,scale,sizeX,sizeZ,maxUsers) VALUES 
 (0,'gold','gold.png',1000,'gold.xml
','rock.mdl',0.5,2,2,4),
...
INSERT INTO `building_to_unit` (id,building,unit) VALUES (0,4,0),
 ...
 (13,4,5),
 (14,5,5);
INSERT INTO `building` (id,name,sizeX,sizeZ,type,model,texture,font,scale,texture_temp,nation,icon,queue_max_capacity) VALUES 
 (0,'house',1,1,0,'House2.mdl','house2.xml','Anonymous Pro.ttf',2.5,'house_temp.xml',0,'house.png',5),
