...
InfluenceMap::InfluenceMap(unsigned short resolution, float size): resolution(resolution), fieldSize(size / resolution),
...
void InfluenceMap::drawCell(int index, short batch) {
	...
	Urho3D::Color color = Game::getColorPaletteRepo()->getColor(getValueAt(index), VALUE_THRESHOLD_DEBUG);
