...
public:
	...
	db_building_metric(float costSum, float defence, float distanceAttack)
		: db_basic_metric(costSum, defence, distanceAttack),
		  params{costSum, defence, distanceAttack} {
		paramsAsSpan = std::span{params};
	}
};
